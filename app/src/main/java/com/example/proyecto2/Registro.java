            ...
            public void onClick(View view) {
                ...
                if(contraseñaIntroducida.equals(contraseñaRepetidaIntroducida)) {
                    ...
                    if (nombreIntroducido.isEmpty() || apellidoIntroducido.isEmpty() || emailIntroducido.isEmpty() || contraseñaIntroducida.isEmpty()) {
                        String camposObligatorios = getString(R.string.camposObligatorios);
                        Toast.makeText(getApplicationContext(), camposObligatorios, Toast.LENGTH_SHORT).show();
                        return;
                    }
                    ...
                    //Aviso error contras
                    int tiempo= Toast.LENGTH_SHORT;
                    String contrasenasNoCoin = getString(R.string.contrasenasNoCoin);
                    Toast aviso = Toast.makeText(getApplicationContext(), contrasenasNoCoin, tiempo);
                    aviso.show();
                }
            }
        });
